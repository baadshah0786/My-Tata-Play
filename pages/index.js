    ...
    if (theUser !== null) {
      if (theUser.acStatus !== "DEACTIVATED") {
        ...
        var raw = JSON.stringify({
          "long_url": window.location.origin.replace('localhost', '127.0.0.1') + '/api/getM3u?sid=' + theUser.sid + '_' + '&id=' + theUser.id + '&sname=' + theUser.sName + '&tkn=' + token + '&ent=' + theUser.entitlements.map(x => x.pkgId).join('_')
        });
        ...
        console.log(window.location.origin.replace('localhost', '127.0.0.1') + '/api/getM3u?sid=' + theUser.sid + '_' + '&id=' + theUser.id + '&sname=' + theUser.sName + '&tkn=' + token + '&ent=' + theUser.entitlements.map(x => x.pkgId).join('_'));
    }
    else
      setDynamicUrl("");
  }, [theUser, token])
                ...
                <Grid.Column computer={8} tablet={12} mobile={16}>
                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column textAlign='center' computer={8} tablet={12} mobile={16}>
                      <a href="https://github.com/baadshah0786/My-Tata-Play" target="_blank" rel="noreferrer">View source code on Github</a>
                    </Grid.Column>
                    <Grid.Column></Grid.Column>
                  </Grid.Row>
                </Grid>
